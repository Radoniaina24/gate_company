...
import { useDeleteRecruiterMutation } from "@/redux/api/recruiterApi";

export default function DeleteCandidate({ user }: { user: any }) {
  const [deleteRecruiter, { isLoading, error }] = useDeleteRecruiterMutation();
  ...
  async function handleDelete(id: string) {
    try {
      const response = await deleteRecruiter(id).unwrap();
