        ...
        {users?.length > 0 ? (
                        ...
                        <img
                          ...
                          onError={(e) => {
                            e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(
                              user.nom || `${user.firstName} ${user.lastName}`
                            )}&background=random&color=fff`;
                          }}
                        />
                      </div>
                      {/* Statut badge sur la photo */}
          ...
          <div className="flex flex-col items-center justify-center p-12 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <p className="text-gray-500 text-center max-w-sm">
              Il n'y a actuellement aucun candidat à afficher. Les nouveaux
              candidats apparaîtront ici une fois inscrits.
            </p>
          </div>
        )}
      </div>
